...
<body>
    ...
    <tr class="menu-row">
        <td class="menu-btn menu-icon-schedule">
            <a href="schedule.php" class="non-style-link-menu">
                <div>
                    <p class="menu-text">Programación</p>
                </div>
            </a>
        </td>
    </tr>
        ...
        <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
            ...
            <tr>
                <td colspan="2" style="padding-top:30px;">
                    <p class="heading-main12" style="margin-left: 45px;font-size:20px;color:rgb(49, 49, 49)">Agregar un Doctor</p>
                </td>
                <td colspan="2">
                        ...
                        <div class="abc scroll">
                            <table width="93%" class="sub-table scrolldown" border="0">
                                ...
                                <tbody>
                                    ...
                                    <a class="non-style-link" href="doctors.php"><button  class="login-btn btn-primary-soft btn"  style="display: flex;justify-content: center;align-items: center;margin-left:20px;">&nbsp; Ver todos los Doctores &nbsp;</font></button>
                                    </a>
                                    </center>
                                    <br><br><br><br>
                                    </td>
    ...
    if ($_GET) {
        ...
        if ($action == 'drop') {
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <div class="content">
                            Quiere eliminar el registro<br>(' . substr($nameget, 0, 40) . ').
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="nic" class="form-label">Identificación </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
            ...
            $error_1 = $_GET["error"];
            $errorlist = array(
                '1' => '<label for="promter" class="form-label" style="color:rgb(255, 62, 62);text-align:center;">Ya existe una cuenta para este Correo.</label>',
                '2' => '<label for="promter" class="form-label" style="color:rgb(255, 62, 62);text-align:center;">Error en el formato de la contraseña</label>',
            ...
            <div id="popup1" class="overlay">
                    ...
                    . '</td>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="text" name="name" class="input-text" placeholder="Nombre del Medico" required><br>
                                </td>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="text" name="nic" class="input-text" placeholder="Numero de Identificación" required><br>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="tel" name="Tele" class="input-text" placeholder="ej: 60001111" required><br>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="spec" class="form-label">Seleccione una Especialidad </label>
                ...
                echo     '       </select><br>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="password" name="password" class="input-text" placeholder="Ingrese una Contraseña" required><br>
                                </td>
                            </tr><tr>
                                <td class="label-td" colspan="2">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="password" name="cpassword" class="input-text" placeholder="Confirme su Contraseña" required><br>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
            ...
            ';
                ...
                echo '
                    <div id="popup1" class="overlay">
                            ...
                            <center>
                            <br><br><br><br>
                                <h2>Registro Añadido con Exito!</h2>
                                <a class="close" href="doctors.php">&times;</a>
                                <div class="content">
        ...
        ';
            ...
            $errorlist = array(
                '1' => '<label for="promter" class="form-label" style="color:rgb(255, 62, 62);text-align:center;">Ya existe una cuenta para este Correo.</label>',
                '2' => '<label for="promter" class="form-label" style="color:rgb(255, 62, 62);text-align:center;">Error en la Confirmación de Clave</label>',
                '3' => '<label for="promter" class="form-label" style="color:rgb(255, 62, 62);text-align:center;"></label>',
                '4' => "",
                '0' => '',
            ...
            if ($error_1 != '4') {
                echo '
                    ...
                    . '</td>
                                    ...
                                    <tr>
                                        ...
                                        ID del Doctor : ' . $id . ' (Generado Automaticamente)<br><br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-td" colspan="2">
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="text" name="nic" class="input-text" placeholder="Numero de Identificación" value="' . $nic . '" required><br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-td" colspan="2">
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="tel" name="Tele" class="input-text" placeholder="ej: 60001111" value="' . $tele . '" required><br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-td" colspan="2">
                ...
                echo     '       </select><br><br>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="password" name="cpassword" class="input-text" placeholder="Ingrese nuevamente la clave" required><br>
                                        </td>
                                    </tr>
                ...
                <div id="popup1" class="overlay">
                        ...
                        <center>
                        <br><br><br><br>
                            <h2>Se ha midificado el Registro con Exito!</h2>
                            <a class="close" href="doctors.php">&times;</a>
                            <div class="content">
